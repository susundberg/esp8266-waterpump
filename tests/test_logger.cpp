...
TEST_CASE( "Logging ", "[logger]" ) 
{
   ...
   SECTION("Logging errors")
   {
      ...
      LOG_INFO("THIS IS OK" );
      LOG_FATAL("THIS IS SOOOOO LONG ERROR THAT I DONT HANDLE IT THIS IS SOOOOO LONG ERROR THAT I DONT HANDLE IT THIS IS SOOOOO LONG ERROR THAT I DONT HANDLE IT THIS IS SOOOOO LONG ERROR THAT I DONT HANDLE IT THIS IS SOOOOO LONG ERROR THAT I DONT HANDLE IT");
