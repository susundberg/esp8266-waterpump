...
/**
This is automatically generate mock file (from /home/pauli/DEV/arduino/water-pump/src/device_pin_out.h). If you wish to edit this, move this to mocks_man directory.
*/
#ifndef _AUTOMOCK_DEVICE_PIN_OUT_H
#define _AUTOMOCK_DEVICE_PIN_OUT_H
...
DECLARE_FAKE_VOID_FUNC( Device_pin_out__set_value,  Device_pin_out*, int );

#endif // _AUTOMOCK_DEVICE_PIN_OUT_H
